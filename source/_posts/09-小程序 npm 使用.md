...
<img src="/img/miniprogram/构建完成.jpg" style="zoom:80%;" />
...
1. 初始化 `package.json`，**这一步至关重要，要不然后续的步骤都很难进行下去**
   ...
   <img src="/img/miniprogram/46-初始化package.jpg" style="zoom:80%;" />
...
2. 通过 npm 安装 `@vant/weapp` 包
   ...
   ![](/img/miniprogram/vant-weapp.jpg)

   

3. 构建 npm

   <img src="/img/miniprogram/构建vant-weapp.jpg" style="zoom:60%;" />

   <img src="/img/miniprogram/vant 构建完成.jpg" style="zoom:67.8%;" />
...
<img src="/img/miniprogram/vant 组件库.jpg" style="zoom:60%; border: 1px solid #ccc" />
...
<img src="/img/miniprogram/构建失败.jpg" style="zoom:76%;" />
...
<img src="/img/miniprogram/接触样式隔离.jpg" style="zoom:80%;" />
...
<img src="/img/miniprogram/自定义样式类.jpg" style="zoom:80%; border: 1px solid #ccc" />
...
![](/img/miniprogram/CSS 变量修改演示.jpg)
