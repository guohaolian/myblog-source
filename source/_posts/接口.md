...
![image-20260303201236756](/img/node/image-20260303201236756.png)

## 1.3 接口的开发与调用

大多数接口都是由 后端工程师开发的， 开发语言不限

一般情况下接口都是由 前端工程师调用的，但有时 后端工程师也会调用接口，比如短信接口，支付接口 等
...
![image-20260303201421892](/img/node/image-20260303201421892.png)
