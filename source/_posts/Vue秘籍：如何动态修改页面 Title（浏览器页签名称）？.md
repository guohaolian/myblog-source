---
title: Vue3动态修改页面 Title
date: 2025-03-16 11:23:47
wordcount: 1130
categories: 学习笔记
category_bar: true
tags:
...
在开发<span style="color: rgb(51, 145, 229); user-select: auto;">Vue</span>项目时，我们经常需要根据不同的页面动态修改浏览器的页签标题（ `title` ），比如：
...
如果你的项目是 **多页面应用（SPA）** ，通常会<span style="color: rgb(51, 145, 229); user-select: auto;">使用</span>Vue Router来管理页面切换。在这种情况下，我们可以 **在全局导航守卫中监听路由变化** ，并根据 `meta` 字段动态修改 `title` 。
