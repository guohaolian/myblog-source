...
<img src="/img/miniprogram/案例效果.png" style="zoom:40%;" />
...
<img src="/img/miniprogram/公司宣传语.png" style="zoom:60%;" />
...
<img src="/img/miniprogram/商品导航区域.png" style="zoom:50%;" />
...
<img src="/img/miniprogram/推荐商品区域.png" style="zoom:48%;" />
...
<img src="/img/miniprogram/scroll-x.gif" style=" border: 1px solid #ccc" />
...
<img src="/img/miniprogram/scroll-y.gif" style="zoom:90%; border: 1px solid #ccc" />
...
<img src="/img/miniprogram/字体图标.jpg" style="zoom:50%; border: 1px solid #ccc" />



点击链接，会将生成的 `CSS` 在新的链接页面进行打开，`ctrl + s`，将该文件重命名为`.wxss` 后缀名，然后保存到项目根目录下的`static` 文件夹下。

<img src="/img/miniprogram/字体图标 CSS.jpg" style="zoom:45%; border: 1px solid  #ccc" />
...
<img src="/img/miniprogram/背景图片.jpg" style="zoom: 80%;" />
...
<img src="/img/miniprogram/网络图片.jpg" style="zoom:50%; border: 1px solid #ccc" />
