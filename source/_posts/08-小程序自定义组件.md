...
4. 此时就已经创建了一个功能组件![](/img/miniprogram/创建和注册组件.png)
...
<img src="/img/miniprogram/自定义组件案例.png" style="zoom:80%; border: 1px solid #ccc" />
...
<img src="/img/miniprogram/自定义组件 slot.png" style="zoom:80%; border: 1px solid #ccc" />
...
<img src="/img/miniprogram/组件-具名插槽.png" style="zoom:80%; border: 1px solid #ccc" />
...
<img src="/img/miniprogram/修改复选框样式.png" style="zoom:80%; border: 1px solid #ccc" />
...
<img src="/img/miniprogram/组件生命周期.png" style="zoom:80%; border: 1px solid #ccc" />
...
<img src="/img/miniprogram/组件所在页面的生命周期.png" style="zoom:70%; border: 1px solid #ccc" />
...
<img src="/img/miniprogram/小程序生命周期总结-1.png" style="zoom:80%;border: 1px solid #ccc" />
...
<img src="/img/miniprogram/小程序生命周期总结-2.png"  style="zoom:80%;border: 1px solid #ccc" />



切后台 以及 切前台(热启动)

<img src="/img/miniprogram/小程序生命周期总结-3.png"  style="zoom:80%;border: 1px solid #ccc"  />
